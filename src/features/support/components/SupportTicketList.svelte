        ...
        <div class="empty-state">
            <svg width="64" height="64" viewBox="0 0 64 64" fill="none" class="empty-icon">
                <path d="M32 8C18.745 8 8 18.745 8 32C8 45.255 18.745 56 32 56C45.255 56 56 45.255 56 32C56 18.745 45.255 8 32 8ZM32 52C20.954 52 12 43.046 12 32C12 20.954 20.954 12 32 12C43.046 12 52 20.954 52 32C52 43.046 43.046 52 32 52Z"
                      fill="#9CA3AF"/>
                <path d="M32 18C30.895 18 30 18.895 30 20V32C30 33.105 30.895 34 32 34C33.105 34 34 33.105 34 32V20C34 18.895 33.105 18 32 18Z"
                      fill="#9CA3AF"/>
              ...
              >
                {getPriorityLabel(ticket.priority)}
                    ...
                    <div class="ticket-footer">
                        <div class="responses">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                                <path d="M14 1.5H2C1.175 1.5 0.5 2.175 0.5 3V11C0.5 11.825 1.175 12.5 2 12.5H4V14.5L7.5 12.5H14C14.825 12.5 15.5 11.825 15.5 11V3C15.5 2.175 14.825 1.5 14 1.5Z"
                                      fill="#6B7280"/>
                            </svg>
