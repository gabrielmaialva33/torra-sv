...
<div class="modal-overlay" on:click={handleClose}>
    <div class="modal-content" on:click|stopPropagation>
        ...
        <div class="modal-body">
            ...
            <div class="report-info">
                <svg fill="none" height="16" viewBox="0 0 16 16" width="16">
                    <path d="M8 1C4.13 1 1 4.13 1 8C1 11.87 4.13 15 8 15C11.87 15 15 11.87 15 8C15 4.13 11.87 1 8 1ZM8 13C5.24 13 3 10.76 3 8C3 5.24 5.24 3 8 3C10.76 3 13 5.24 13 8C13 10.76 10.76 13 8 13Z"
                          fill="#3B82F6"/>
        ...
        <div class="modal-footer">
            ...
            <Button on:click={handleGenerate} variant="primary">
                Gerar Relatório
            </Button>
        </div>
    </div>
