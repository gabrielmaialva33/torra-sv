    ...
    <div class="reports-page">
        <div class="page-header">
            ...
            <div class="header-actions">
                <Button on:click={() => handleExport('pdf')} variant="secondary">
                    <svg class="mr-2" fill="none" height="16" viewBox="0 0 16 16" width="16">
                        <path d="M13 9V13H3V9H2V13C2 13.55 2.45 14 3 14H13C13.55 14 14 13.55 14 13V9H13Z"
                              fill="currentColor"/>
                        <path d="M8 10L11.5 6.5L10.79 5.79L8.5 8.09V2H7.5V8.09L5.21 5.79L4.5 6.5L8 10Z"
                              fill="currentColor"/>
                    </svg>
                    Exportar PDF
                </Button>
                <Button on:click={() => handleExport('excel')} variant="secondary">
                    <svg class="mr-2" fill="none" height="16" viewBox="0 0 16 16" width="16">
                        <path d="M13 9V13H3V9H2V13C2 13.55 2.45 14 3 14H13C13.55 14 14 13.55 14 13V9H13Z"
                              fill="currentColor"/>
                        <path d="M8 10L11.5 6.5L10.79 5.79L8.5 8.09V2H7.5V8.09L5.21 5.79L4.5 6.5L8 10Z"
                ...
                {#if stores.length > 0}
                    <Button variant="primary" on:click={openStoreReports}>
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" class="mr-2">
                            <path d="M4 2V4H12V2H4ZM3 0H13C13.55 0 14 0.45 14 1V5C14 5.55 13.55 6 13 6H3C2.45 6 2 5.55 2 5V1C2 0.45 2.45 0 3 0Z"
                                  fill="currentColor"/>
                            <path d="M4 8V10H12V8H4ZM3 7H13C13.55 7 14 7.45 14 8V11C14 11.55 13.55 12 13 12H3C2.45 12 2 11.55 2 11V8C2 7.45 2.45 7 3 7Z"
                                  fill="currentColor"/>
                        </svg>
                        Relatório por Loja
                    </Button>
        ...
        <ReportsFilters {filters} on:change={handleFilterChange} {stores}/>
